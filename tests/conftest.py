...
def mock_external_services():
    ...
    with patch('app.services.logging_service.GOOGLE_CLOUD_AVAILABLE', False), \
         patch('app.services.cache_service.CACHE_AVAILABLE', False), \
         patch('app.agents.professional_agent.get_professional_retriever') as mock_prof_retriever, \
         patch('app.agents.education_agent.get_education_retriever') as mock_edu_retriever, \
         patch('app.agents.learning_agent.get_learning_retriever') as mock_learn_retriever, \
         patch('app.agents.redirect_agent.get_redirect_retriever') as mock_redirect_retriever, \
         patch('app.agents.professional_agent.ChatGoogleGenerativeAI') as mock_llm, \
         patch('app.agents.professional_agent.ConversationalRetrievalChain') as mock_chain:
